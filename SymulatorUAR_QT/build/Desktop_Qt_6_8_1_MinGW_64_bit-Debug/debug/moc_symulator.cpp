...
namespace {
struct qt_meta_tag_ZN9symulatorE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN9symulatorE = QtMocHelpers::stringData(
    "symulator"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9symulatorE[] = {
...
Q_CONSTINIT const QMetaObject symulator::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9symulatorE.offsetsAndSizes,
    qt_meta_data_ZN9symulatorE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9symulatorE_t,
        // Q_OBJECT / Q_GADGET
...
void *symulator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9symulatorE.stringdata0))
